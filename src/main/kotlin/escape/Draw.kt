...
fun Canvas.drawArena(game: Game) {
	erase()
	drawGrid()
	drawActor(game.hero, game.stepAnim, "escapeResources\\Hero.png")
	game.robots.forEach {
		drawActor(it, game.stepAnim, "escapeResources\\robot.png")
	}
...
const val TEXT_BASE = 10 // Vertical separation of a text from base
...
private fun Canvas.drawJunk(junk: Position) {
	drawImage("escapeResources\\junk", junk.x * CELL_SIDE, junk.y * CELL_SIDE, CELL_SIDE, CELL_SIDE)
}