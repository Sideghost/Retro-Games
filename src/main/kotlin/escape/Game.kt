...
const val ANIM_STEPS = 8    // Animation steps between cells (multiple of CELL_SIDE)
...
/**
 * Game info
 * @property hero Position and direction of a hero
 ...
 * @property garbage Position of each junk pile
 * @property status Current state of the game
 */
data class Game(
	val hero: Actor, val robots: List<Actor>, val stepAnim: Int,
